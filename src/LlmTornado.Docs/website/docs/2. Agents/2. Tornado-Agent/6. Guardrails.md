...
permissions["send_email"] = true;      // Requires permission
permissions["read_file"] = false;      // No permission needed
permissions["delete_data"] = true;     // Requires permission
...
{
    Conversation result = await agent.Run(input);
